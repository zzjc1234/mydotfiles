...
vim.keymap.set("n", "<leader>g", function() require("trouble").first({skip_groups = true, jump = true}) end)
vim.keymap.set("n", "<leader>G", function() require("trouble").last({skip_groups = true, jump = true}) end)
